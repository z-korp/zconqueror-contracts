...
mod tests {
    ...
    use super::{Game, GameTrait, Turn, TURN_COUNT, DEFAULT_PLAYER_COUNT};
    ...
    fn test_game_new() {
        ...
        assert(game.player_count == DEFAULT_PLAYER_COUNT, 'Game: wrong player_count');
